...
- При необходимости точечно сверить шаблоны с фактическими process-артефактами из `.windsurf/sandbox/MAIL/**`.
...
- `.aiassistant/rules/LEAD.md`
- `.aiassistant/rules/VERIFIER.md`
- релевантные process-образцы из `.windsurf/sandbox/MAIL/**`, если они нужны как фактический reference
...
- отчёт VERIFIER: `.windsurf/sandbox/MAIL/VERIFIER/OUT/T0016_20260417-1803_VERIFIER_validate-templates-against-rules-and-process_report.md`
