...
- Current file:
  `.windsurf/sandbox/00_STATE.md:3` -> `NextTicket: T0015`
  `.windsurf/sandbox/00_STATE.md:6` -> `Active: T0014`
  `.windsurf/sandbox/00_STATE.md:33-34` -> `T0016` уже в `Done`
...
- Skills boundary:
  move repeatable recipes to `.aiassistant/skills`
