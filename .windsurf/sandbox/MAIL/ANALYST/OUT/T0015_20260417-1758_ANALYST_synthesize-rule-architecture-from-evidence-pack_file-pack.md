...
1. Read `AGENTS.md`.
2. Read `.aiassistant/rules/00_COMMON.md`.
3. Read `.aiassistant/rules/specs/CONTROL_FLOW.md`.
...
7. Introduce a physical `.aiassistant/skills` layer.
8. Clarify ownership/update-flow for `.windsurf/sandbox/00_STATE.md`.
...
4. Create the physical `.aiassistant/skills` layer and move only reusable recipes there.
