...
- supporting artifacts из `.agents-runtime/MAIL/ANALYST/OUT/`, созданные в `T0014`
...
- основной отчёт ANALYST: `.agents-runtime/MAIL/ANALYST/OUT/T0015_20260417-1758_ANALYST_synthesize-rule-architecture-from-evidence-pack_report.md`
- optional supporting artifacts в `.agents-runtime/MAIL/ANALYST/OUT/` только если без них нельзя собрать сильный upload pack в пределах 4 файлов
