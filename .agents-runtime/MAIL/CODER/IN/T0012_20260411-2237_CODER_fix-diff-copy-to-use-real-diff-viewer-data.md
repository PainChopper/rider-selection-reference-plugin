...
- текущий тикет/реализация: `.agents-runtime/MAIL/CODER/IN/T0011_20260411-2220_CODER_implement-ide-language-detection-and-diff-copy-format.md`
- отчёт CODER: `.agents-runtime/MAIL/CODER/OUT/T0011_20260411-2220_CODER_implement-ide-language-detection-and-diff-copy-format_report.md`
...
- отчёт CODER: `.agents-runtime/MAIL/CODER/OUT/T0012_20260411-2237_CODER_fix-diff-copy-to-use-real-diff-viewer-data_report.md`
